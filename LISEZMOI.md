...
| `w1600` | 1600 px | **plafond des pages** |
...
**Les pages s'arrêtent à 1600 px.** Sur la plus grande mise en page (environ
1270 px affichés) cela laisse encore 1,26 fois la densité d'un écran retina,
pour un tiers de poids en moins. Le `w3200`, lui, garde la qualité 84 : il
n'est servi qu'à la visionneuse, où la photo est regardée en grand.

Deux mécanismes garantissent que l'animation de révélation se joue sur une
photo déjà là, et non sur un cadre vide :

- les images passent en chargement immédiat **2200 px avant** d'entrer à
  l'écran, au lieu d'attendre le déclenchement paresseux du navigateur ;
- le volet ne se lève qu'une fois l'image décodée (avec un filet de 3 s).
